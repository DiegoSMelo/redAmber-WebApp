...
public class ReservaEquipamentoMB {
	...
	private List<HoraAula> listaHorarios;
	...
	public ReservaEquipamentoMB() {
		...
		listaHorarios = new ArrayList<HoraAula>();
	}
	...
	public List<HoraAula> getListaHorarios() {
	...
	public void setListaHorarios(List<HoraAula> listaHorarios) {
